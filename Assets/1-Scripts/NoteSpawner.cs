...
public class NoteSpawner : MonoBehaviour
{
    ...
    public float greenLaneX = 1.5f;
    public float yellowLaneX = 0.5f;
    public float blueLaneX = -0.5f;
    public float redLaneX = -1.5f;
    ...
    void SpawnRandomNote()
    {
        ...
        if (notePrefab != null)
        {
            ...
            note.transform.position = new Vector3(laneX, -0.2f, spawnZ);
